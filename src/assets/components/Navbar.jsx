    ...
    <div>
      <header className="navbar navbar-expand-lg fixed-top mb-4 border-bottom">
        ...
        <nav className="container d-flex align-items-center justify-content-between">
          ...
          <ul className="collapse navbar-collapse navbar-nav col-lg-4 mb-2 justify-content-center mb-md-0 order-2 order-lg-0" id="navbarToggler">
          ...
          <div className="col-lg-4 mb-2 mb-md-0 text-center">
